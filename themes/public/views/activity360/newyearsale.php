...
var initFlashData = function() {
    ...
    for( var i = 0; i < newYearSaleCtrl.flash_sale_data.products.length; i++ ) {
        ...
        if( newYearSaleCtrl.flash_sale_data.status == 2 )
            newYearSaleCtrl.flash_sale_data.products[i].button_label = "准备开抢"; else if( newYearSaleCtrl.flash_sale_data.status ==
                                                                                        3 ) {
...
<script type="text/javascript" src="http://stat.union.360.cn/js/qunion.js"></script>
<script>
