...
<!--    <div class="activity-header" ms-class-1="kidadult-image:pageType == 1" ms-class-2="carnival-image:pageType == 2 " ms-class-3="shopping-image:pageType == 3 "></div>-->
    <img src="themes/public/images/activities/carnival-11.11/activity-header.jpg" width="100%" ms-if="pageType == 2">
    <img src="themes/public/images/activities/shopping/activity-header.jpg" width="100%" ms-if="pageType == 3">
    <div class="theme-park" ms-repeat-group="allData.groups" ms-attr-id="'park_' + group.group_id"
        ...
        <div class="container">
            <div class="park-name">{{group.name}}<span ms-class="color-white:pageType == 1 && $index % 2 == 1">{{group.en_name}}</span>
            <a  target="_self" ms-href={{group.group_link_url}}  ms-if="group.group_link_url">更多{{group.name}}产品 ></a>
            </div>
            ...
            <div class="one-product" ms-repeat-product="group.products">
                ...
                <a class="product-block" ms-if="pageType == 1">
                    <img class="product-cover" ms-src="{{product.cover_image_url}}?imageView2/1/w/240/h/210">
                    ...
                    <div class="product-mask">
                        <div class="mask-top">
                            <img class="qr-code" ms-src="{{product.qr_code_url}}?imageView2/1/w/140/h/140">
