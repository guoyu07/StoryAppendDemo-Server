<script type="text/ng-template" id="HotelRoom.html">
<div class="view-edit-section last clearfix">
<section class="one-section-action" ng-if="local.current_edit == -1">
    <div class="rooms-container">
        <div class="room-type-container" ng-repeat="room in data.room_list">
            <div>
                <h4 class="room-title" ng-bind="room.name"></h4>
        ...
        <div class="edit-content clearfix">
            ...
            <div class="room-images col-md-16">
                <div class="image-container edit-body grid-bottom">
                    <hi-multiple-uploader options="local.uploader_options.update_cover"></hi-multiple-uploader>
                    <div class="room-images">
                        <div class="room-image col-md-6" ng-repeat="image in data.room_list[local.current_edit].images">
                            <img ng-src="{{ image.image_url }}">
                            <div class="del-btn i i-trash" ng-click="delImage($index)"></div>
                        </div>
                    </div>
                    <!--{{data.room_list[local.current_edit].images}}-->
        ...
        <div class="edit-content clearfix">
            ...
            <div class="col-md-14" style="margin-top: 30px;">
                ...
                <div class="row grid-bottom">
                    ...
                    <div class="col-md-1 i i-plus add-policy" ng-click="addPolicy()">
                ...
                <div class="row">
                    <div hi-markdown input="data.room_list[local.current_edit].bed_policy_md.md_text"
                         output="data.room_list[local.current_edit].bed_policy_md.md_html"></div>
                </div>
                <div class="row">
                    <label class="col-md-4">早餐费用</label>
                </div>
                <div class="row">
                    <div hi-markdown input="data.room_list[local.current_edit].breakfast_md.md_text"
                         output="data.room_list[local.current_edit].breakfast_md.md_html"></div>
                </div>
            </div>
        </div>
    </div>
...
<button type="submit" class="col-xs-offset-2 col-xs-4 btn btn-hg btn-primary save-form"
        ng-click="submitChanges()" data-ng-disabled="hotel_room_form.$invalid">
    保存
</button>
</form>
</section>
