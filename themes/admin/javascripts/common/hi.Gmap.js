...
var HImap = {
    ...
    drawMarkers                 : function(map, coords) {
        ...
        for(var i = 0; i < coords.length; i++) {
            ...
            var marker = new google.maps.Marker({
                ...
                map      : map,
                icon     : {
                    url    : 'themes/admin/images/images/map_ico.png',
    ...
    loadGoogleMap               : function() {
        ...
        script.src = 'http://maps.google.cn/maps/api/js?libraries=geometry&key=AIzaSyB062x7b2UUvRIMLRIHJ8rFaZXGSkca89c&sensor=false&' +
                     'callback=HImap.init';
