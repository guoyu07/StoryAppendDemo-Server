...
/**
 * This is the model class for table "citytours_hotel".
 *
 * The followings are the available columns in table 'citytours_hotel':
 ...
 */
class CitytoursHotel extends CActiveRecord
{
	/**
	 ...
	 * @return CitytoursHotel the static model class
	 */
