 ...
 *
 * The followings are the available columns in table 'currency_info':
 ...
 */
class CurrencyInfo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('code, name, enname', 'required'),
			...
			array('code, name, enname, comment, order_num', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CurrencyInfo the static model class
	 */
