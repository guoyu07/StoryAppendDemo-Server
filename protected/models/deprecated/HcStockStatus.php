...
/**
 * This is the model class for table "hc_stock_status".
 *
 * The followings are the available columns in table 'hc_stock_status':
 * @property integer $stock_status_id
 * @property integer $language_id
 * @property string $name
 */
class HcStockStatus extends CActiveRecord
{
	/**
	 ...
	 * @return HcStockStatus the static model class
	 */
