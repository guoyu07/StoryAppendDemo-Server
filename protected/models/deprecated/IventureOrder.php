...
/**
 * This is the model class for table "iventure_order".
 *
 * The followings are the available columns in table 'iventure_order':
 * @property integer $id
 ...
 */
class IventureOrder extends CActiveRecord
{
	/**
	 ...
	 * @return IventureOrder the static model class
	 */
