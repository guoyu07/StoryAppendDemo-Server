...
/**
 * This is the model class for table "iventure_order_passenger".
 *
 * The followings are the available columns in table 'iventure_order_passenger':
 ...
 */
class IventureOrderPassenger extends CActiveRecord
{
	/**
	...
	{
		return 'iventure_order_passenger';
	}
	 ...
	 * @return IventureOrderPassenger the static model class
	 */
