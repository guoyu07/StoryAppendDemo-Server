...
/**
 * This is the model class for table "hc_information_description".
 *
 * The followings are the available columns in table 'hc_information_description':
 * @property integer $information_id
 * @property integer $language_id
 * @property string $title
 * @property string $description
 */
class HcInformationDescription extends CActiveRecord
{
	/**
	...
	{
		return 'hc_information_description';
	}
	 ...
	 * @return HcInformationDescription the static model class
	 */
