...
/**
 * This is the model class for table "hc_customer_history".
 *
 * The followings are the available columns in table 'hc_customer_history':
 * @property integer $customer_history_id
 * @property integer $customer_id
 * @property string $comment
 * @property string $date_added
 */
class HcCustomerHistory extends CActiveRecord
{
	/**
	 ...
	 * @return HcCustomerHistory the static model class
	 */
