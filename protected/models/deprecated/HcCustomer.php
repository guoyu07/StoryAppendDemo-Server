...
/**
 * This is the model class for table "hc_customer".
 *
 * The followings are the available columns in table 'hc_customer':
 ...
 */
class HcCustomer extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('store_id, newsletter, address_id, customer_group_id, status, approved, bind_third', 'numerical', 'integerOnly'=>true),
			...
			array('customer_id, store_id, firstname, lastname, email, telephone, fax, password, salt, cart, wishlist, newsletter, address_id, customer_group_id, ip, status, approved, token, date_added, bind_third', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return HcCustomer the static model class
	 */
