...
/**
 * This is the model class for table "hc_filter_description".
 *
 * The followings are the available columns in table 'hc_filter_description':
 * @property integer $filter_id
 * @property integer $language_id
 * @property integer $filter_group_id
 * @property string $name
 */
class HcFilterDescription extends CActiveRecord
{
	/**
	 ...
	 * @return HcFilterDescription the static model class
	 */
