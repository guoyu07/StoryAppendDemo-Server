...
/**
 * This is the model class for table "hc_customer_ip".
 *
 * The followings are the available columns in table 'hc_customer_ip':
 * @property integer $customer_ip_id
 * @property integer $customer_id
 * @property string $ip
 * @property string $date_added
 */
class HcCustomerIp extends CActiveRecord
{
	/**
	 ...
	 * @return HcCustomerIp the static model class
	 */
