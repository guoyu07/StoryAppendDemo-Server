...
/**
 * This is the model class for table "hc_attribute_group_description".
 *
 * The followings are the available columns in table 'hc_attribute_group_description':
 * @property integer $attribute_group_id
 * @property integer $language_id
 * @property string $name
 */
class HcAttributeGroupDescription extends CActiveRecord
{
	/**
	...
	{
		return 'hc_attribute_group_description';
	}
	 ...
	 * @return HcAttributeGroupDescription the static model class
	 */
