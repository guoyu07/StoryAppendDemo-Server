...
/**
 * This is the model class for table "iventure_tour_operation".
 *
 * The followings are the available columns in table 'iventure_tour_operation':
 ...
 */
class IventureTourOperation extends CActiveRecord
{
	/**
	...
	{
		return 'iventure_tour_operation';
	}
	 ...
	 * @return IventureTourOperation the static model class
	 */
