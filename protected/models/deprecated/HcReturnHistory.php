...
/**
 * This is the model class for table "hc_return_history".
 *
 * The followings are the available columns in table 'hc_return_history':
 ...
 */
class HcReturnHistory extends CActiveRecord
{
	/**
	 ...
	 * @return HcReturnHistory the static model class
	 */
