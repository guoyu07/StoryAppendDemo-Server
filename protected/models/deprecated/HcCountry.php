...
/**
 * This is the model class for table "hc_country".
 *
 * The followings are the available columns in table 'hc_country':
 ...
 */
class HcCountry extends CActiveRecord
{
	/**
	 ...
	 * @return HcCountry the static model class
	 */
