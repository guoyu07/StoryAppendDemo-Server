...
/**
 * This is the model class for table "hc_review".
 *
 * The followings are the available columns in table 'hc_review':
 ...
 */
class HcReview extends CActiveRecord
{
	/**
	 ...
	 * @return HcReview the static model class
	 */
