...
/**
 * This is the model class for table "iventure_price_plan".
 *
 * The followings are the available columns in table 'iventure_price_plan':
 ...
 */
class IventurePricePlan extends CActiveRecord
{
	/**
	 ...
	 * @return IventurePricePlan the static model class
	 */
