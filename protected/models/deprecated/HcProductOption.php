...
/**
 * This is the model class for table "hc_product_option".
 *
 * The followings are the available columns in table 'hc_product_option':
 ...
 */
class HcProductOption extends CActiveRecord
{
	/**
	 ...
	 * @return HcProductOption the static model class
	 */
