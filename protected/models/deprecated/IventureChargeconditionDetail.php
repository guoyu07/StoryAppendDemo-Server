...
/**
 * This is the model class for table "iventure_chargecondition_detail".
 *
 * The followings are the available columns in table 'iventure_chargecondition_detail':
 * @property integer $id
 ...
 * @property string $msg
 */
class IventureChargeconditionDetail extends CActiveRecord
{
	/**
	...
	{
		return 'iventure_chargecondition_detail';
	}
	 ...
	 * @return IventureChargeconditionDetail the static model class
	 */
