...
/**
 * This is the model class for table "hc_category_description".
 *
 * The followings are the available columns in table 'hc_category_description':
 ...
 */
class HcCategoryDescription extends CActiveRecord
{
	/**
	...
	{
		return 'hc_category_description';
	}
	 ...
	 * @return HcCategoryDescription the static model class
	 */
