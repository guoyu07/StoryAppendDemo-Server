...
/**
 * This is the model class for table "hc_order_option".
 *
 * The followings are the available columns in table 'hc_order_option':
 ...
 */
class HcOrderOption extends CActiveRecord
{
	/**
	 ...
	 * @return HcOrderOption the static model class
	 */
