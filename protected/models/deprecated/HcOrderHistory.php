...
/**
 * This is the model class for table "hc_order_history".
 *
 * The followings are the available columns in table 'hc_order_history':
 ...
 */
class HcOrderHistory extends CActiveRecord
{
	/**
	 ...
	 * @return HcOrderHistory the static model class
	 */
