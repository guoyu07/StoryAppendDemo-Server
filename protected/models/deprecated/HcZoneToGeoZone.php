...
/**
 * This is the model class for table "hc_zone_to_geo_zone".
 *
 * The followings are the available columns in table 'hc_zone_to_geo_zone':
 ...
 */
class HcZoneToGeoZone extends CActiveRecord
{
	/**
	 ...
	 * @return HcZoneToGeoZone the static model class
	 */
