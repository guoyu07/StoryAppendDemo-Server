...
/**
 * This is the model class for table "hc_product_combo".
 *
 * The followings are the available columns in table 'hc_product_combo':
 * @property integer $product_id
 * @property integer $sub_product_id
 */
class HcProductCombo extends CActiveRecord
{
	/**
	 ...
	 * @return HcProductCombo the static model class
	 */
