...
/**
 * This is the model class for table "hc_custom_field_to_customer_group".
 *
 * The followings are the available columns in table 'hc_custom_field_to_customer_group':
 * @property integer $custom_field_id
 * @property integer $customer_group_id
 */
class HcCustomFieldToCustomerGroup extends CActiveRecord
{
	/**
	...
	{
		return 'hc_custom_field_to_customer_group';
	}
	 ...
	 * @return HcCustomFieldToCustomerGroup the static model class
	 */
