...
/**
 * This is the model class for table "hc_option_value_description".
 *
 * The followings are the available columns in table 'hc_option_value_description':
 * @property integer $option_value_id
 * @property integer $language_id
 * @property integer $option_id
 * @property string $name
 */
class HcOptionValueDescription extends CActiveRecord
{
	/**
	...
	{
		return 'hc_option_value_description';
	}
	 ...
	 * @return HcOptionValueDescription the static model class
	 */
