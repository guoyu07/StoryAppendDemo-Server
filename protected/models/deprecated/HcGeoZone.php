...
/**
 * This is the model class for table "hc_geo_zone".
 *
 * The followings are the available columns in table 'hc_geo_zone':
 ...
 */
class HcGeoZone extends CActiveRecord
{
	/**
	 ...
	 * @return HcGeoZone the static model class
	 */
