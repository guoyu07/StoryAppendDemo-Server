...
/**
 * This is the model class for table "hc_category".
 *
 * The followings are the available columns in table 'hc_category':
 ...
 */
class HcCategory extends CActiveRecord
{
	/**
	 ...
	 * @return HcCategory the static model class
	 */
