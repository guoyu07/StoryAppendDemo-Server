...
/**
 * This is the model class for table "hc_coupon_base".
 *
 * The followings are the available columns in table 'hc_coupon_base':
 ...
 */
class HcCouponBase extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, type, discount, available_count, logged, shipping, total, city_name, avail_date, special_price, product_id, image, uses_total, uses_customer, status', 'required'),
			array('available_count, logged, shipping, product_id, uses_total, status', 'numerical', 'integerOnly'=>true),
			...
			array('coupon_base_id, name, type, discount, available_count, logged, shipping, total, date_start, date_end, city_name, avail_date, special_price, product_id, image, uses_total, uses_customer, status, date_added', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return HcCouponBase the static model class
	 */
