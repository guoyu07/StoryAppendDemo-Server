...
/**
 * This is the model class for table "hc_download".
 *
 * The followings are the available columns in table 'hc_download':
 ...
 */
class HcDownload extends CActiveRecord
{
	/**
	 ...
	 * @return HcDownload the static model class
	 */
