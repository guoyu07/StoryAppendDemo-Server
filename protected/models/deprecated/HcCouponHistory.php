...
/**
 * This is the model class for table "hc_coupon_history".
 *
 * The followings are the available columns in table 'hc_coupon_history':
 ...
 */
class HcCouponHistory extends CActiveRecord
{
	/**
	 ...
	 * @return HcCouponHistory the static model class
	 */
