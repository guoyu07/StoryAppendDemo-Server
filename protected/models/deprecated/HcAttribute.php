...
/**
 * This is the model class for table "hc_attribute".
 *
 * The followings are the available columns in table 'hc_attribute':
 * @property integer $attribute_id
 * @property integer $attribute_group_id
 * @property integer $sort_order
 */
class HcAttribute extends CActiveRecord
{
	/**
	 ...
	 * @return HcAttribute the static model class
	 */
