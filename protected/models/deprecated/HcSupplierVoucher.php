...
/**
 * This is the model class for table "hc_supplier_voucher".
 *
 * The followings are the available columns in table 'hc_supplier_voucher':
 * @property integer $id
 ...
 */
class HcSupplierVoucher extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('product_id, manufacturer_id, tour_date', 'required'),
			...
			array('id, product_id, manufacturer_id, booking_reference, tour_date, city_code, item_id, special_code, confirmation_ref, current_status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return HcSupplierVoucher the static model class
	 */
