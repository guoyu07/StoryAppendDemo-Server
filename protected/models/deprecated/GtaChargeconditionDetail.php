...
/**
 * This is the model class for table "gta_chargecondition_detail".
 *
 * The followings are the available columns in table 'gta_chargecondition_detail':
 * @property integer $id
 ...
 * @property string $msg
 */
class GtaChargeconditionDetail extends CActiveRecord
{
	/**
	...
	{
		return 'gta_chargecondition_detail';
	}
	 ...
	 * @return GtaChargeconditionDetail the static model class
	 */
