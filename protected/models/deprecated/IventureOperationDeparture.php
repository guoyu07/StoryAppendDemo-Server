...
/**
 * This is the model class for table "iventure_operation_departure".
 *
 * The followings are the available columns in table 'iventure_operation_departure':
 ...
 */
class IventureOperationDeparture extends CActiveRecord
{
	/**
	...
	{
		return 'iventure_operation_departure';
	}
	 ...
	 * @return IventureOperationDeparture the static model class
	 */
