...
/**
 * This is the model class for table "hc_information_to_layout".
 *
 * The followings are the available columns in table 'hc_information_to_layout':
 * @property integer $information_id
 * @property integer $store_id
 * @property integer $layout_id
 */
class HcInformationToLayout extends CActiveRecord
{
	/**
	...
	{
		return 'hc_information_to_layout';
	}
	 ...
	 * @return HcInformationToLayout the static model class
	 */
