...
/**
 * This is the model class for table "hc_affiliate".
 *
 * The followings are the available columns in table 'hc_affiliate':
 ...
 */
class HcAffiliate extends CActiveRecord
{
	/**
	 ...
	 * @return HcAffiliate the static model class
	 */
