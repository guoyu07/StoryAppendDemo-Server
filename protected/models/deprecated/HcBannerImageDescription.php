...
/**
 * This is the model class for table "hc_banner_image_description".
 *
 * The followings are the available columns in table 'hc_banner_image_description':
 * @property integer $banner_image_id
 * @property integer $language_id
 * @property integer $banner_id
 * @property string $title
 */
class HcBannerImageDescription extends CActiveRecord
{
	/**
	...
	{
		return 'hc_banner_image_description';
	}
	 ...
	 * @return HcBannerImageDescription the static model class
	 */
