...
/**
 * This is the model class for table "hc_product_operation_departure".
 *
 * The followings are the available columns in table 'hc_product_operation_departure':
 ...
 */
class HcProductOperationDeparture extends CActiveRecord
{
	/**
	...
	{
		return 'hc_product_operation_departure';
	}
	...
	public function rules()
	{
		...
		return array(
			array('operation_id, departure_id, time, first_service, last_service, intervals, departure_point, address_lines, telephone, description, language_id', 'required'),
	 ...
	 * @return HcProductOperationDeparture the static model class
	 */
