...
/**
 * This is the model class for table "hc_custom_field_value_description".
 *
 * The followings are the available columns in table 'hc_custom_field_value_description':
 * @property integer $custom_field_value_id
 * @property integer $language_id
 * @property integer $custom_field_id
 * @property string $name
 */
class HcCustomFieldValueDescription extends CActiveRecord
{
	/**
	...
	{
		return 'hc_custom_field_value_description';
	}
	 ...
	 * @return HcCustomFieldValueDescription the static model class
	 */
