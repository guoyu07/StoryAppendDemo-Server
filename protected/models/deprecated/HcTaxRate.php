...
/**
 * This is the model class for table "hc_tax_rate".
 *
 * The followings are the available columns in table 'hc_tax_rate':
 ...
 */
class HcTaxRate extends CActiveRecord
{
	/**
	 ...
	 * @return HcTaxRate the static model class
	 */
