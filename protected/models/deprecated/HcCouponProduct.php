...
/**
 * This is the model class for table "hc_coupon_product".
 *
 * The followings are the available columns in table 'hc_coupon_product':
 * @property integer $coupon_product_id
 * @property integer $coupon_id
 * @property integer $product_id
 */
class HcCouponProduct extends CActiveRecord
{
	/**
	 ...
	 * @return HcCouponProduct the static model class
	 */
