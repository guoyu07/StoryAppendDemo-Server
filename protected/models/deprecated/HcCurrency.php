...
/**
 * This is the model class for table "hc_currency".
 *
 * The followings are the available columns in table 'hc_currency':
 ...
 */
class HcCurrency extends CActiveRecord
{
	/**
	 ...
	 * @return HcCurrency the static model class
	 */
