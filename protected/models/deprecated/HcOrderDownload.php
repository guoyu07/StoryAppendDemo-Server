...
/**
 * This is the model class for table "hc_order_download".
 *
 * The followings are the available columns in table 'hc_order_download':
 ...
 */
class HcOrderDownload extends CActiveRecord
{
	/**
	 ...
	 * @return HcOrderDownload the static model class
	 */
