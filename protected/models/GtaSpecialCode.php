...
/**
 * This is the model class for table "gta_special_code".
 *
 * The followings are the available columns in table 'gta_special_code':
 ...
 */
class GtaSpecialCode extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('city_code, item_id, special_code, special_title', 'required'),
			array('language_id', 'numerical', 'integerOnly'=>true),
			array('city_code, special_code', 'length', 'max'=>4),
			array('item_id', 'length', 'max'=>16),
			array('special_title', 'length', 'max'=>64),
	 ...
	 * @return GtaSpecialCode the static model class
	 */
