...
/**
 * This is the model class for table "ht_setting".
 *
 * The followings are the available columns in table 'ht_setting':
 ...
 */
class HtSetting extends CActiveRecord
{
	/**
	 ...
	 * @return HtSetting the static model class
	 */
