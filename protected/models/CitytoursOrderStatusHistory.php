...
/**
 * This is the model class for table "citytours_order_status_history".
 *
 * The followings are the available columns in table 'citytours_order_status_history':
 * @property integer $id
 ...
 */
class CitytoursOrderStatusHistory extends CActiveRecord
{
	/**
	...
	{
		return 'citytours_order_status_history';
	}
	 ...
	 * @return CitytoursOrderStatusHistory the static model class
	 */
