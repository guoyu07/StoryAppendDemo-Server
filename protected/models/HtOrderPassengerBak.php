 ...
 */
class HtOrderPassengerBak extends HActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('order_id, order_product_id, ticket_id, birth_date, height, passport_issue_date, passport_expire_date, taiwan_pass_expire_date, hk_pass_expire_date, mobile, child_age, arrival_date, arrival_flight_no, leave_date, merged_fields', 'required'),
            array('order_id, order_product_id, ticket_id, gender, age, height, is_child, child_age', 'numerical', 'integerOnly' => true),
    ...
    public function defaultScope()
    {
        return array(
            'alias' => 'opx',
            'order' => 'opx.order_passenger_id ASC');
    }
     ...
     * @return HtOrderPassengerBak the static model class
     */
    ...
    public function updateMe($data)
    {
        ...
        $isok = HtOrderPassengerBak::model()->updateByPk($data['order_passenger_id'], $data);
