...
/**
 * This is the model class for table "citytours_order_passenger".
 *
 * The followings are the available columns in table 'citytours_order_passenger':
 ...
 */
class CitytoursOrderPassenger extends CActiveRecord
{
	/**
	...
	{
		return 'citytours_order_passenger';
	}
	...
	public function rules()
	{
		...
		return array(
			array('order_id, booking_reference, passenger_id, en_name', 'required'),
			array('order_id, passenger_id, is_child, child_age', 'numerical', 'integerOnly'=>true),
			...
			array('order_id, booking_reference, passenger_id, zh_name, en_name, passport_number, is_child, child_age', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CitytoursOrderPassenger the static model class
	 */
