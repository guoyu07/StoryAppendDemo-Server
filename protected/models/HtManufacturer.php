...
/**
 * This is the model class for table "ht_manufacturer".
 *
 * The followings are the available columns in table 'ht_manufacturer':
 ...
 */
class HtManufacturer extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, cn_name, sort_order', 'required'),
	 ...
	 * @return HtManufacturer the static model class
	 */
