...
/**
 * This is the model class for table "citytours_pass".
 *
 * The followings are the available columns in table 'citytours_pass':
 ...
 */
class CitytoursPass extends CActiveRecord
{
	/**
	 ...
	 * @return CitytoursPass the static model class
	 */
