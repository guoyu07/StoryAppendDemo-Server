...
class Weather extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('landmark_id, insert_time, weather', 'required'),
			array('landmark_id, insert_time', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('landmark_id, insert_time, weather', 'safe', 'on'=>'search'),
		);
	}
