...
/**
 * This is the model class for table "gta_operation_departure".
 *
 * The followings are the available columns in table 'gta_operation_departure':
 ...
 */
class GtaOperationDeparture extends CActiveRecord
{
	/**
	...
	{
		return 'gta_operation_departure';
	}
	 ...
	 * @return GtaOperationDeparture the static model class
	 */
