...
/**
 * This is the model class for table "citytours_chargecondition_detail".
 *
 * The followings are the available columns in table 'citytours_chargecondition_detail':
 * @property integer $id
 ...
 * @property string $msg
 */
class CitytoursChargeconditionDetail extends CActiveRecord
{
	/**
	...
	{
		return 'citytours_chargecondition_detail';
	}
	...
	public function rules()
	{
		...
		return array(
			array('type, charge, allowable, from_date, to_date, currency, effective_from_date, effective_to_date', 'required'),
	 ...
	 * @return CitytoursChargeconditionDetail the static model class
	 */
