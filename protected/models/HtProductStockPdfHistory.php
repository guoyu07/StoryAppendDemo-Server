...
/**
 * This is the model class for table "ht_product_stock_pdf_history".
 *
 * The followings are the available columns in table 'ht_product_stock_pdf_history':
 ...
 */
class HtProductStockPdfHistory extends CActiveRecord
{
	/**
	...
	{
		return 'ht_product_stock_pdf_history';
	}
	...
	public function rules()
	{
		...
		return array(
			array('product_id, ticket_id, source_filename, source_comment, target_filename, target_dir, duplication_info, upload_time, status', 'required'),
			array('product_id, ticket_id, confirmed_count, status', 'numerical', 'integerOnly'=>true),
			array('source_filename, target_filename, target_dir', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('batch_id, product_id, ticket_id, source_filename, source_comment, target_filename, target_dir, duplication_info, confirmed_count, upload_time, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'ticket' => array(self::HAS_ONE, 'HtTicketType', '', 'on' => 't.ticket_id = tt.ticket_id'),
		);
	}
	 ...
	 * @return HtProductStockPdfHistory the static model class
	 */
